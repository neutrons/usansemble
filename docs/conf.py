...
# Included repo READMEs use repo-relative links that are correct on GitHub but do
# not resolve to doc pages. Suppress only that cross-reference warning so
# ReadTheDocs' fail_on_warning still catches real problems.
